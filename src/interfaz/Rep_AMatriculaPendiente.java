...
public class Rep_AMatriculaPendiente extends javax.swing.JFrame {


    public Rep_AMatriculaPendiente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Alumnos con matrícula pendiente:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Rep_AMatriculaPendiente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Rep_AMatriculaPendiente().setVisible(true);
            }
        });
    }
