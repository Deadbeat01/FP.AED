...
public class Rep_AMatriculaVigente extends javax.swing.JFrame {


    public Rep_AMatriculaVigente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Alumnos con matrícula vigente:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Rep_AMatriculaVigente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Rep_AMatriculaVigente().setVisible(true);
            }
        });
    }
