...
public class Cons_AlumnosCurso extends javax.swing.JFrame {


    public Cons_AlumnosCurso() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cons_AlumnosCurso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cons_AlumnosCurso().setVisible(true);
            }
        });
    }
