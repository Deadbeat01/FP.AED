...
public class Cons_MatriculasRetiros extends javax.swing.JFrame {


    public Cons_MatriculasRetiros() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setText("BUSCAR MATRÍCULA");
        ...
        jButton2.setText("BUSCAR RETIRO");
        ...
        jLabel2.setText("Número de retiro");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cons_MatriculasRetiros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cons_MatriculasRetiros().setVisible(true);
            }
        });
    }
